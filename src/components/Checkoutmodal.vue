            ...
            <div v-else>
                ...
                <div class="p-5 border-b">
                    ...
                    <div v-if="withDrawType === 'sucursal'" class="flex flex-col gap-4">
                        <div>
                            ...
                            <select v-model="sucursalSeleccionada" class="w-full p-2 border rounded-lg">
                ...
                <div class="p-5 border-b">
                    ...
                    <div class="flex gap-2 mb-4">
                        ...
                        <button @click="metodoPago = 'sinpe'; obtenerUbicacion()"
                    ...
                    <div v-if="metodoPago === 'sinpe'" class="bg-gray-50 rounded-lg p-3 text-sm text-center">
                        ...
                        <p class="text-gray-500 mt-1">A nombre de Foodmania</p>
...
const obtenerUbicacion = () => {
    ...
    sucursalesStore.sucursalesFoodMania.forEach((item) => {
        if (item.Nombre === locationStore.sucursalCercana) {
            ...
            datosCliente.value.lat = locationStore.lat || datosCliente.value.lat
            datosCliente.value.lng = locationStore.lng || datosCliente.value.lng
        }
    })
}
...
const abrirEnMaps = () => {
    ...
    const url = `https://www.google.com/maps?q=${datosCliente.value.lat},${datosCliente.value.lng}`
...
const confirmarPedido = async () => {
    ...
    if (metodoPago.value === 'efectivo') {
        ...
        if (Number(montoEfectivo.value) < totalConEnvio.value) return errorMsg.value = 'El monto es menor al total del pedido.'
    }
    ...
    try {
        ...
        const whatsappUrl = `https://wa.me/506${numeroLimpio}?text=${encodeURIComponent(mensaje)}`
